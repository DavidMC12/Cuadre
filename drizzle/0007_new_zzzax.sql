...
ALTER TABLE "accounts" ADD CONSTRAINT "accounts_linked_account_fk" FOREIGN KEY ("user_id","linked_account_id","currency") REFERENCES "public"."accounts"("user_id","id","currency") ON DELETE restrict ON UPDATE no action;--> statement-breakpoint
